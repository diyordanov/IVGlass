...
const TYPES: ShowerType[] = [
  {
    ...
    svg: (
      <svg viewBox="0 0 160 160" fill="none" aria-hidden="true">
        <path d="M40 26v108M40 26h66v108H40" stroke="#5FA8F0" strokeWidth="2" />
        <path d="M106 26l15 10v96l-15 2" stroke="#023E98" strokeWidth="2" />
        <path d="M40 134h81" stroke="#BFD9FB" strokeWidth="2" />
        <circle cx="96" cy="82" r="2.5" fill="#023E98" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 160" fill="none" aria-hidden="true">
        <path d="M34 30v102h92V30" stroke="#5FA8F0" strokeWidth="2" />
        <path d="M80 30v102" stroke="#023E98" strokeWidth="2" />
        <path d="M80 30l26 12v76l-26 14" stroke="#023E98" strokeWidth="2" />
        <circle cx="97" cy="82" r="2.5" fill="#023E98" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 160" fill="none" aria-hidden="true">
        <path d="M36 34v96h86V34H36z" stroke="#5FA8F0" strokeWidth="2" />
        <path d="M78 34v96M83 34v96" stroke="#023E98" strokeWidth="1.7" />
        <path d="M54 78h50" stroke="#BFD9FB" strokeWidth="1.5" strokeDasharray="5 5" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 160" fill="none" aria-hidden="true">
        <path d="M38 32v98h52V32H38zM90 32l30 16v82H90" stroke="#5FA8F0" strokeWidth="2" />
        <path d="M90 32v98" stroke="#023E98" strokeWidth="2" />
        <path d="M38 130h82" stroke="#BFD9FB" strokeWidth="2" />
      </svg>
    ),
  },
];
        ...
        <div className="grid grid-cols-4 gap-4 max-[900px]:grid-cols-2 max-[560px]:grid-cols-1">
          {TYPES.map((t, i) => (
            <article
              key={t.num}
              data-reveal
              className={`border border-[var(--line)] rounded-[24px] p-6 transition-all duration-400 relative overflow-hidden hover:-translate-y-[7px] hover:shadow-[var(--shadow)] hover:border-[rgba(46,141,244,.22)] ${['', 'delay-1', 'delay-2', 'delay-3'][i]}`}
              style={{
            ...
            >
              <div className="h-[190px] grid place-items-center mb-[22px] relative max-[560px]:h-40">
                <div
                  ...
                  style={{ background: 'radial-gradient(circle,rgba(192,221,252,.22),transparent 68%)' }}
                />
                <div className="w-[150px] h-[150px] relative z-[2]" style={{ filter: 'drop-shadow(0 18px 20px rgba(2,40,90,.10))' }}>
                  {t.svg}
                </div>
              </div>
